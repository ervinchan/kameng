      ...
      .then((res) => {
        if (1 === res.code) {
          ...
          this.formData = {
            ...
            lender_amount     : data.lender_amount || '',
            lender_rate       : data.lender_rate || '',
            repay_date_limit  : {
              name: data.repay_date_limit + '个月' || '',
              value: data.repay_date_limit || '',
            },
            ...
            lender_type       : {
              name: data.lender_type || ''
            },
            lender_desc       : data.lender_desc || '',
          };
        }
      });
    },
