<template>
  <div class="peer-edit-page">
    <app-header title="修改资料" :other="isCompany" v-on:other="isCompany = false"></app-header>
    <scroller>
      <div v-show="!isApplySuccess" class="wrapper">
          ...
          <ul class="list">
            ...
            <li class="item">
              ...
              <div class="right" v-on:click.stop="handleCityShowChange">
                <div class="input">
                  <input type="text" class="readyonly-input" v-model="city.region_name" readonly placeholder="请选择">
                </div>
                <i class="sp sp-right"></i>
              </div>
            </li>
          ...
          <ul class="pass-data-list">
            ...
            <li class="item">
              ...
              <div class="right">
                <div class="input">
                  <input type="file"
                    class="file readyonly-input"
                    name="image"
                    accept="image/*"
                    ref="company_license"
                    v-on:change="setImage($event, 'company_license')"/>
                </div>
              ...
              <div class="right">
                <div class="input">
                  <input type="file"
                    ...
                    accept="image/*"
                    ref="work_card"
                    v-on:change="setImage($event, 'work_card')"/>
                </div>
        ...
        <div class="btn-submit" v-on:click="handleSubmit">保存</div>
      </div>
    </scroller>
    <div v-if="isApplySuccess" class="apply-submit-success">
      ...
      <router-link class="btn-loan" :to="{ path: '/'}">
        ...
        <div class="btn-toTop" @click="toTop"  >立即置顶</div>
