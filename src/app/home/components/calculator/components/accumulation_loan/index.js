...
export default {
  ...
  computed: {
    value1 () {
      return _.get(this.$store.get.state, 'AccumulationLoan.formData.businessDownPaymentRatio');
    },
    value2 () {
      return _.get(this.$store.get.state, 'AccumulationLoan.formData.businessMortgageYears');
    }
