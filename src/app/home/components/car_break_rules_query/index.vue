<template>
  <div class="car-rules-query-page">
        ...
        <div class="wrapper">
          ...
          <div class="query-list" v-if="isShowPage">
            <div class="query-item" v-for="(item, index) in peccancyList" :key="index">
              <div class="input-group" :class="{ 'on': item.status }" @click="selectPeccancyId(item)">
              ...
              <ul class="detail-list">
                <li>
                  ...
                  <span class="text">({{carNumber}})</span>
                </li>
                <li>
                  <span class="item-h">违章地点：</span>
                  <span class="item-c">{{ item.location_name }}</span>
                </li>
                <li>
...
<!--                 <li>
                  <h4>服务费</h4>
                  <span class="item-c-color2">￥{{ item.servicePrice }}</span>
                </li> -->
                <li>
                  <h4>罚款</h4>
...
<!--           <div class="query-tips" v-else>
      ...
      <div class="nocarbreak-tips" v-if="isShowNoPeccancyTips">
        <div class="tips-content">
          ...
          <div class="confirm">
            <a href="javascript:" v-on:click.stop="$router.go(-1)">返回</a>
            <a href="javascript:" @click="stayQuery">人工查询</a>
          </div>
        </div>
      </div>
      ...
      <div class="query-order-detail" v-if="isShowOrderDetail">
        <div class="order-detail-wrapper">
          ...
          <scroller>
            <div class="wrapper">
              <ul class="order-list" v-for="(item, index) in peccancyList" v-show="item.status">
      ...
      <div class="repair-popup" v-show="isShowRepairPopup">
        <div class="repair-content">
          ...
          <router-link :to="{ name: 'home.RepairData', query: { carId: carId } }">
