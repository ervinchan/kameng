...
export default {
  ...
  mounted () {
    this.loanInfo.total = this.getTotal(30, 60);
    if (50 < this.loanInfo.total) {
      this.loanInfo.text = '较高';
    }
    else {
      this.loanInfo.text = '较低';
    }
    let totals = 100 - this.loanInfo.total;
    // this.init(this.loanInfo.total, totals);
    setTimeout(() => {
      this.init(this.loanInfo.total, totals);
    }, 20);
  },
                ...
                itemStyle: {
                  normal: {
                    color: new Echarts.graphic.LinearGradient(0, 0, 0, 1, [
                      {
                        offset: 0, color: '#fcbc24',
                      },
                      {
                        offset: 1, color: '#fcbc24',
                      }
                    ], false)
                  }
                }
