    ...
    <scroller>
      <div class="wrapper">
        <div class="controller">
          ...
          <div class="photo">
						<div class="convert">
							<router-link :to="{ name: 'user.ExchangeRule' }">兑换规则</router-link>
						</div>
						<div class="integral">
							<div class="figure">{{ integral }}</div>
							<p class="info">
								<span class="present">当前积分</span>
								<span class="add_up">已累计签到{{ times }}天</span>
							</p>
						</div>
						<div class="purpose">
							<div class="make-over">
								<router-link :to="{ name: 'user.MakeOver' }">
									<i class="sp sp-make-over"></i>
									积分转让
								</router-link>
							</div>
							<div class="deduction">
								<router-link :to="{ name: 'user.IntegralDeduction' }">
									<i class="sp sp-deduction"></i>
									积分抵扣
								</router-link>
							</div>
						</div>
          ...
          <div class="main">
            <div class="convert_box">
							...
							<router-link :to="{  name: 'home.ConvertRecord' }" class="record">
								<i class="sp sp-record-icon"></i>
								兑换记录
							</router-link>
						</div>
						<div class="box_list">
      ...
      <div class="member">
        ...
        <span class="abolish" v-show="needToShip">
